...
public class StartActivity extends Activity {
  ...
  private void setupWindowAnimations () {
    ...
    //getWindow().setEnterTransition(null);// put slideLeft as argument for whole Activity View to move. Case 4.
    //getWindow().setExitTransition(null);// put slideLeft as argument for whole Activity View to move. Case 4.
  }
}
/* Introduction:
 ...
 */
  ...
  */
  ...
  /* Case 4: Set enter and exit transitions for window as slide left.
     ...
     Then replace null with slideLeft to setEnterTransition and setExitTransiton methods.
